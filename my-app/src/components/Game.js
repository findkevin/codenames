...
//Use AppState to determine if the app is in the fore/background, and notify you when the state changes.
...
import { changeRole, toggleColourblind, toggleNightMode} from '../actions/userOptionsActions';
      ...
      <div id="game">
        <div id="board">
          <div id="top-bar">
            ...
            <button id="end-turn" onClick={this.endTurn}>End {playingTeam}&apos;s turn</button>
          </div>
          <Board
        ...
        >
          ...
          {/* <div id="expansions"> */}
            ...
            {/* <div> */}
              {/* <input id="vanilla" value="vanilla"
              className={"expansion" + this.highlightIfClicked('VANILLA')} type="image" src="/images/vanilla.png" alt="Base Game" onClick={this.toggleWordPack} /> */}
